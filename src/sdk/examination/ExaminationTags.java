...
public class ExaminationTags {
	...
	public static void main(String[] args) {
		...
		String json = FileUtil.readStream(path+"ExaminationTags.json");
		String result = HttpJSONRequest.post(Const.DO_MAIN_URL+"/third/wechat/load/examination/tags/nologin", json);
		System.out.println(result);
	}
