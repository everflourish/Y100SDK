...
public class ExaminationStudentList {
	...
	private static String path = ExaminationStudentList.class.getResource("").getPath();
	public static void main(String[] args) {
		...
		String json = FileUtil.readStream(path+"ExaminationStudentList.json");
		String result = HttpJSONRequest.post(Const.DO_MAIN_URL+"third/api/examination/marking/scan/studentanswer/get/nologin", json);
		System.out.println(result);
	}
